...
static void TextSpeed_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_TextSpeedMid, 124, YPOS_TEXTSPEED, styles[1]);
    DrawOptionMenuChoice(gText_TextSpeedFast, 144, YPOS_TEXTSPEED, styles[2]);
    DrawOptionMenuChoice(gText_TextSpeedInstant, 160, YPOS_TEXTSPEED, styles[3]);
}
